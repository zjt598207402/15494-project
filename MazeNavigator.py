...
class MazeNavigator(StateMachineProgram):
    ...
    def setup(self):
        """
            ...
            checkObject =F=> StateNode() =T(1)=> Build_walls() =C=> 
        ...
        # Code generated by genfsm on Thu May  4 22:08:31 2017:
        ...
        say1 = Say("I SEE IT") .set_name("say1") .set_parent(self)
        
        completiontrans1 = CompletionTrans() .set_name("completiontrans1")
        completiontrans1 .add_sources(initmaze1) .add_destinations(checkObject)
        
        failuretrans1 = FailureTrans() .set_name("failuretrans1")
        failuretrans1 .add_sources(checkObject) .add_destinations(statenode1)
        
        timertrans1 = TimerTrans(1) .set_name("timertrans1")
        timertrans1 .add_sources(statenode1) .add_destinations(build_walls1)
        ...
        completiontrans4 .add_sources(turncustom1) .add_destinations(checkObject)
        
        successtrans2 = SuccessTrans() .set_name("successtrans2")
        successtrans2 .add_sources(checkObject) .add_destinations(say1)
